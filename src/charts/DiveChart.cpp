#include "DiveChart.hpp"
namespace spx
{
  // vereinfache mal das geschreibsel
  using namespace QtCharts;

  DiveChart::DiveChart( std::shared_ptr< Logger > logger,
  ...
  void DiveChart::showDiveDataInGraph( const QString &deviceAddr, int diveNum )
  {

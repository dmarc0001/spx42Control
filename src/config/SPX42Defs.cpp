...
namespace spx42
{
  SPX42License::SPX42License(void) :
    ...
    licInd( IndividualLicense::LIC_NONE )
  {

  }

  SPX42License::SPX42License( SPX42License& lic ) : QObject()
  {
    licType = lic.licType;
    licInd = lic.licInd;
  }
  ...
  bool SPX42License::operator == (const SPX42License& lic )
  {
    ...
    //
    if( licType != lic.licType ) return( false );
    if( licInd != lic.licInd ) return( false );
    return( true );
  }
  ...
  bool SPX42License::operator != (const SPX42License& lic )
  {
    ...
    // wenn was nicht gleich ist, dann sind sie ungleich!
    //
    if( licType != lic.licType ) return( true );
    if( licInd != lic.licInd ) return( true );
    return( false );
  }
